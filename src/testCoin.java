...
public class testCoin {
 ...
 //Creates a coin and adds to list manually.
    public void spawnCoinManually(double x, double y) {
        GOval coin = new GOval(COIN_SIZE, COIN_SIZE);
        coin.setFilled(true);
        coin.setFillColor(Color.YELLOW);
        coin.setLocation(x, y);

        coinsOnPlatforms.add(coin); //adds to list
        if (program != null) {
            program.add(coin); // Display it
        }
